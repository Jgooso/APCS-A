   ...
   {   
   	//WRITE CODE FOR THIS METHOD
		...
		while(num >= 10) {
			...
			if(getCheck(numWithCheckDigit/10) == num) {
				return true;
...
Create a class variable and a new method that calls the isValid method and if it is called will increment the count
variable by one.
*/
